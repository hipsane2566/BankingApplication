...
public class LoginSteps {
	...
	@Given("Open app url")
	public static void open_app_url() throws IOException {
		loginPage = new LoginPage(BaseClass.getDriver());
	}

	@When("User enter username as {string} and password as {string}")
	public static void enter_user_name_as_and_password_as(String username, String password) {
	...
	public static void user_enter_username_and_password_with_excel_row(String rows) {
